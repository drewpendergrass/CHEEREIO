...
bigy = pt.makeYEachAssimPeriod(path_to_bigy_subsets=f"{pp_dir}/bigy",assim_time=int(ASSIM_TIME),OBS_TYPE=OBS_TYPE,fullpath_output_name=f'{pp_dir}/SNAPSHOT_bigY.pkl')
...
arraysbase = pt.makeBigYArrays(bigy,gclat,gclon,nEnsemble,av_to_grid=av_to_gc_grid, observers_to_plot_as_points=OBSERVERS_TO_PLOT_AS_POINTS,OBS_TYPE=OBS_TYPE,extra_obsdata_fields=extra_obsdata_fields,useControl=do_control,swoosh_path=swoosh_path)

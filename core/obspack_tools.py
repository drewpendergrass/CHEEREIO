...
def read_obspack(filename):
	data_to_keep = ['time', 'start_time', 'midpoint_time', 'time_components', 'value', 'latitude', 'longitude', 'altitude', 'assimilation_concerns','obspack_id']

	# Initialize list for obspack data
	met = {}
